...
- [ ] 1.1 在 BLTabBarViewController.swift 中删除创建 FeedViewController 的代码（约 3 行）
- [ ] 1.2 在 BLTabBarViewController.swift 中删除创建 HotViewController 的代码（约 3 行）
- [ ] 1.3 在 BLTabBarViewController.swift 中删除创建 RankingViewController 的代码（约 3 行）
- [ ] 1.4 在 BLTabBarViewController.swift 中添加 selectedIndex 映射逻辑以处理旧索引值
...
- [ ] 3.1 检查 README.md 是否包含推荐/热门/排行榜功能的描述，如有则更新或移除相关说明
- [ ] 3.2 更新项目文档（如有）说明主导航变更

## 4. 完成清理

- [ ] 4.1 提交代码变更到 git，commit message 说明变更内容
